...

{
  ...
  \includepdf[pages=20-36]{/home/skaestle/specs/rust/ownership}
}
...
{
  \setbeamercolor{background canvas}{bg=}
  \includepdf[pages=9-19]{/home/skaestle/specs/rust/ownership}
}
...
{
  \setbeamercolor{background canvas}{bg=}
  \includepdf[pages=87-107]{/home/skaestle/specs/rust/ownership-and-borrowing}
}
